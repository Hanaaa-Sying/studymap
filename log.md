...
## 2026-05-22 · v1.1 — Google Analytics 埋点

**新增**
- 接入 Google Analytics（GA4），自动采集 PV/UV、设备类型、地区、停留时长

---

## 2026-05-22 · v1.0 — 移动端适配

**新增**
- 响应式 CSS：手机/iPad（≤540px）下卡片内边距收窄、翻译按钮自动换行、页面可正常滚动

---

## 2026-05-22 · v0.9 — 使用说明 + 翻译选项

**新增**
- 界面新增可折叠"使用说明"，点击展开后说明两种模式的定位与适用场景，不局限于课件场景
- 新增"输出语言"三档选项：保持原文 / 翻译语言 / 中英双语
  - 翻译语言：用户自选源语言（含自动检测）和目标语言，支持中/英/日/韩/法/西/德
  - 中英双语：输出节点标题为"中文 · English"格式
- 修复拖拽上传 bug：改用 `DataTransfer` 对象正确写入 `input.files`
